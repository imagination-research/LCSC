...
from improved_ddpm.models.diffusion import Model
from improved_ddpm.models.improved_ddpm.unet import UNetModel as ImprovedDDPM_Model
from improved_ddpm.models.guided_diffusion.unet import UNetModel as GuidedDiffusion_Model
from improved_ddpm.models.guided_diffusion.unet import EncoderUNetModel as GuidedDiffusion_Classifier
from improved_ddpm.models.guided_diffusion.unet import SuperResModel as GuidedDiffusion_SRModel
from improved_ddpm.models.ema import EMAHelper
from improved_ddpm.functions import get_optimizer
from improved_ddpm.functions.losses import loss_registry
from improved_ddpm.datasets import get_dataset, data_transform, inverse_data_transform
from improved_ddpm.functions.ckpt_util import get_ckpt_path
from improved_ddpm.evaluate.fid_score import calculate_fid_given_paths
...
class Diffusion(object):
    def __init__(self, args, config, rank=None):
        ...
        self.betas = torch.tensor(betas, dtype=torch.float32).to(dist_util.dev())
        betas = self.betas
        ...
        alphas_cumprod_prev = torch.cat(
            [torch.ones(1).to(dist_util.dev()), alphas_cumprod[:-1]], dim=0
        )
        posterior_variance = (
