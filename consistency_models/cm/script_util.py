...
def create_model_and_diffusion(
    ...
    if model_type == "edm":
        from .unet_edm import SongUNet
        with open(edm_model_kwargs_path, "r") as f:
            edm_model_kwargs = yaml.safe_load(f)
        model = SongUNet(**edm_model_kwargs)
    elif model_type == "adm":
        model = create_model(
            image_size,
            num_channels,
